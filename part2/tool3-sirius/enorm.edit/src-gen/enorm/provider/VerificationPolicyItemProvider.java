...
/**
 * This is the item provider adapter for a {@link enorm.VerificationPolicy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						EnormPackage.Literals.VERIFICATION_POLICY__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_VerificationPolicy_mode_feature",
								"_UI_VerificationPolicy_type"),
						EnormPackage.Literals.VERIFICATION_POLICY__MODE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_VerificationPolicy_appliesWhen_feature",
								"_UI_VerificationPolicy_type"),
						EnormPackage.Literals.VERIFICATION_POLICY__APPLIES_WHEN, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_VerificationPolicy_verifies_feature",
								"_UI_VerificationPolicy_type"),
						EnormPackage.Literals.VERIFICATION_POLICY__VERIFIES, true, false, true, null, null, null));
	}
