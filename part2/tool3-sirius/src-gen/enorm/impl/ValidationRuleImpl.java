 ...
 * </p>
 * <ul>
 *   <li>{@link enorm.impl.ValidationRuleImpl#getName <em>Name</em>}</li>
 *   <li>{@link enorm.impl.ValidationRuleImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link enorm.impl.ValidationRuleImpl#getSeverity <em>Severity</em>}</li>
 *   <li>{@link enorm.impl.ValidationRuleImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link enorm.impl.ValidationRuleImpl#getImplementationId <em>Implementation Id</em>}</li>
 *   <li>{@link enorm.impl.ValidationRuleImpl#getAppliesToResource <em>Applies To Resource</em>}</li>
 *   <li>{@link enorm.impl.ValidationRuleImpl#getAppliesToFeedback <em>Applies To Feedback</em>}</li>
 *   <li>{@link enorm.impl.ValidationRuleImpl#getInvokedBy <em>Invoked By</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ValidationRuleImpl extends MinimalEObjectImpl.Container implements ValidationRule {
	...
	protected EClass eStaticClass() {
		return EnormPackage.Literals.VALIDATION_RULE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnormPackage.VALIDATION_RULE__NAME, oldName, name));
	}
	...
	public void setKind(ValidationKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnormPackage.VALIDATION_RULE__KIND, oldKind, kind));
	}
	...
	public void setSeverity(RuleSeverity newSeverity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnormPackage.VALIDATION_RULE__SEVERITY, oldSeverity,
					severity));
	}
	...
	public void setExpression(String newExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnormPackage.VALIDATION_RULE__EXPRESSION,
	...
	public void setImplementationId(String newImplementationId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnormPackage.VALIDATION_RULE__IMPLEMENTATION_ID,
			...
			if (appliesToResource != oldAppliesToResource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							EnormPackage.VALIDATION_RULE__APPLIES_TO_RESOURCE, oldAppliesToResource,
							appliesToResource));
			}
		}
	...
	public void setAppliesToResource(ResourceType newAppliesToResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnormPackage.VALIDATION_RULE__APPLIES_TO_RESOURCE,
	...
	public FeedbackDefinition getAppliesToFeedback() {
		if (appliesToFeedback != null && appliesToFeedback.eIsProxy()) {
			...
			if (appliesToFeedback != oldAppliesToFeedback) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							EnormPackage.VALIDATION_RULE__APPLIES_TO_FEEDBACK, oldAppliesToFeedback,
							appliesToFeedback));
			}
		}
	...
	public void setAppliesToFeedback(FeedbackDefinition newAppliesToFeedback) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnormPackage.VALIDATION_RULE__APPLIES_TO_FEEDBACK,
	...
	public AutomationRule getInvokedBy() {
		if (invokedBy != null && invokedBy.eIsProxy()) {
			...
			if (invokedBy != oldInvokedBy) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EnormPackage.VALIDATION_RULE__INVOKED_BY,
	...
	public void setInvokedBy(AutomationRule newInvokedBy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnormPackage.VALIDATION_RULE__INVOKED_BY,
					oldInvokedBy, invokedBy));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case EnormPackage.VALIDATION_RULE__NAME:
			return getName();
		case EnormPackage.VALIDATION_RULE__KIND:
			return getKind();
		case EnormPackage.VALIDATION_RULE__SEVERITY:
			return getSeverity();
		case EnormPackage.VALIDATION_RULE__EXPRESSION:
			return getExpression();
		case EnormPackage.VALIDATION_RULE__IMPLEMENTATION_ID:
			return getImplementationId();
		case EnormPackage.VALIDATION_RULE__APPLIES_TO_RESOURCE:
			if (resolve)
				return getAppliesToResource();
			return basicGetAppliesToResource();
		case EnormPackage.VALIDATION_RULE__APPLIES_TO_FEEDBACK:
			if (resolve)
				return getAppliesToFeedback();
			return basicGetAppliesToFeedback();
		case EnormPackage.VALIDATION_RULE__INVOKED_BY:
			if (resolve)
				return getInvokedBy();
