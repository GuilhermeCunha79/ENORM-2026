 ...
 * </p>
 * <ul>
 *   <li>{@link enorm.impl.VerificationPolicyImpl#getName <em>Name</em>}</li>
 *   <li>{@link enorm.impl.VerificationPolicyImpl#getMode <em>Mode</em>}</li>
 *   <li>{@link enorm.impl.VerificationPolicyImpl#getAppliesWhen <em>Applies When</em>}</li>
 *   <li>{@link enorm.impl.VerificationPolicyImpl#getVerifies <em>Verifies</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VerificationPolicyImpl extends MinimalEObjectImpl.Container implements VerificationPolicy {
	...
	protected EClass eStaticClass() {
		return EnormPackage.Literals.VERIFICATION_POLICY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnormPackage.VERIFICATION_POLICY__NAME, oldName,
					name));
	}
	...
	public void setMode(ValidationKind newMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnormPackage.VERIFICATION_POLICY__MODE, oldMode,
					mode));
	}
			...
			if (verifies != oldVerifies) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							EnormPackage.VERIFICATION_POLICY__VERIFIES, oldVerifies, verifies));
			}
		}
		return verifies;
	}
	...
	public void setVerifies(FeedbackDefinition newVerifies) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnormPackage.VERIFICATION_POLICY__VERIFIES,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case EnormPackage.VERIFICATION_POLICY__NAME:
			return getName();
