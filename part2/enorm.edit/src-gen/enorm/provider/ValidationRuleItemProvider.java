...
/**
 * This is the item provider adapter for a {@link enorm.ValidationRule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						EnormPackage.Literals.VALIDATION_RULE__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ValidationRule_kind_feature",
								"_UI_ValidationRule_type"),
						EnormPackage.Literals.VALIDATION_RULE__KIND, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ValidationRule_severity_feature",
								"_UI_ValidationRule_type"),
						EnormPackage.Literals.VALIDATION_RULE__SEVERITY, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ValidationRule_expression_feature",
								"_UI_ValidationRule_type"),
						EnormPackage.Literals.VALIDATION_RULE__EXPRESSION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ValidationRule_implementationId_feature",
								"_UI_ValidationRule_type"),
						EnormPackage.Literals.VALIDATION_RULE__IMPLEMENTATION_ID, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ValidationRule_appliesToResource_feature",
								"_UI_ValidationRule_type"),
						EnormPackage.Literals.VALIDATION_RULE__APPLIES_TO_RESOURCE, true, false, true, null, null,
						null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ValidationRule_appliesToFeedback_feature",
								"_UI_ValidationRule_type"),
						EnormPackage.Literals.VALIDATION_RULE__APPLIES_TO_FEEDBACK, true, false, true, null, null,
						null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ValidationRule_invokedBy_feature",
								"_UI_ValidationRule_type"),
						EnormPackage.Literals.VALIDATION_RULE__INVOKED_BY, true, false, true, null, null, null));
	}
