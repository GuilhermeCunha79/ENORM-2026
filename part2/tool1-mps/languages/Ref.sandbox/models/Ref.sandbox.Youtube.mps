...
<model ref="r:e0feae9a-ec4d-4063-9ea7-ba1eca56f7d1(Ref.sandbox.Youtube)">
  <persistence version="9" />
  <languages>
    <use id="75b0389b-83f9-4003-b95d-1b8432efd2b6" name="Ref" version="0" />
  </languages>
  <imports>
    <import index="uyxs" ref="r:42562a9e-3d64-45b7-ab65-7a88d741ffc1(Ref.sandbox)" />
    <import index="3e27" ref="r:3ffbc396-b19b-4af3-b82e-8147a22d5ecd(Ref.sandbox.Amazon)" />
    <import index="a365" ref="r:73b6be4e-a5a9-4750-834a-853bb04c7da8(Ref.sandbox.Reddit)" />
  </imports>
  <registry>
  ...
  <node concept="3$WfeP" id="77Q8YzlE7hS">
    ...
    <node concept="3$WfeS" id="77Q8YzlPhy8" role="3$WffS">
      ...
      <property role="2In6HT" value="1" />
      <property role="2In6HS" value="2" />
      <ref role="2In6HX" to="a365:77Q8YzlE6IE" resolve="Comment" />
      <ref role="28hnIP" to="a365:77Q8YzlE6IE" resolve="Comment" />
    </node>
    ...
    <node concept="3$Wfe3" id="77Q8YzlE7i3" role="nroh4">
      ...
      <node concept="3UnFIO" id="4b31TA4ZheL" role="3UnFH9">
        <ref role="3UnFIR" to="a365:77Q8YzlE6It" resolve="User" />
      </node>
      <node concept="3UnFIO" id="4b31TA4ZheM" role="3UnFH9">
        <ref role="3UnFIR" to="3e27:47EFX_nz$Pp" resolve="Moderator" />
      </node>
    </node>
