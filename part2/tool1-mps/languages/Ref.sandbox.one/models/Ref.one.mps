...
<model ref="r:1ddaa7bd-d4ea-47ae-8a72-9dbee569dd6b(Ref.sandbox.one)">
  ...
  <node concept="3$WfeP" id="77Q8YzlE6Io">
    ...
    <node concept="3$Wfeo" id="4AWrYK6$Tw" role="2IgU2G">
      <property role="2InxWK" value="77Q8YzgwKYX/ON_FEEDBACK_CREATE" />
      <property role="2InxWL" value="7vG6G7pGwnC/AUTOMATIC" />
      <property role="TrG5h" value="ReportOnCommentReview" />
      <ref role="28hnIN" node="77Q8YzlE6IT" resolve="ReportOnComment" />
    </node>
