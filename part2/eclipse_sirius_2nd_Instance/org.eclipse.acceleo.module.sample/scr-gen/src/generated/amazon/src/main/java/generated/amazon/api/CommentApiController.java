...
public class CommentApiController {
    ...
    @GetMapping
    public List<String> list(@RequestParam(required = false) String productId) { return List.of(); }
    ...
    public List<String> votes(@PathVariable String commentId) { return List.of(); }

    @PostMapping("/{commentId}/votes")
    @ResponseStatus(HttpStatus.CREATED)
    public Map<String, String> createVote(@PathVariable String commentId, @RequestBody Map<String, Object> payload) { return Map.of("commentId", commentId, "status", "vote-created"); }

    @DeleteMapping("/{commentId}/votes/{voteId}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void deleteVote(@PathVariable String commentId, @PathVariable String voteId) {}
}
