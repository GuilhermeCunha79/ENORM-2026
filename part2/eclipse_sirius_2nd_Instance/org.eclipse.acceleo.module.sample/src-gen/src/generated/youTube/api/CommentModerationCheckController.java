...
import generated.youTube.service.CommentModerationCheckService;
...
public class CommentModerationCheckController {
    ...
    @GetMapping("/{id}")
    public CommentModerationCheckDto get(@PathVariable String id) {
        return service.get(id);
    }

    @PostMapping
    @ResponseStatus(HttpStatus.CREATED)
    public CommentModerationCheckDto create(@RequestBody CommentModerationCheckDto dto) {
        return service.create(dto);
    }

    @PutMapping("/{id}")
    public CommentModerationCheckDto update(@PathVariable String id, @RequestBody CommentModerationCheckDto dto) {
