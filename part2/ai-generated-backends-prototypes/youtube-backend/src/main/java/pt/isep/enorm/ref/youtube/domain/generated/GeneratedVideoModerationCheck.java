...
public abstract class GeneratedVideoModerationCheck {
    ...
    public VideoModerationType getType() {
        return type;
    }

    public void setType(VideoModerationType type) {
        this.type = type;
    }

    public VideoModerationResult getResult() {
        return result;
    }

    public void setResult(VideoModerationResult result) {
        this.result = result;
    }
