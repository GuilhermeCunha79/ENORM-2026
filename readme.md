[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=22939066)
...
The PlantUML diagram files must be included in the **diagrams** folder. The file build.gradle is configured with a plugin that supports PlantUML.

To generate diagram simple execute "./gradlew plantUml" (or "gradlew.bat plantUml" in Windows) in a terminal (having the root of the project as the current folder).

The repository includes an example of a PlantUML diagram in diagrams/usecase.puml.

The resulting diagram images will be produced in the folder **diagramsOut**.

![PlantUML Diagram Example](diagramsOut/usecase.png)

## Issues and Commits

Each team will have a fork of this repository automatically generated by GitHub Classrooms.
