 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.ResourceRelationImpl#getName <em>Name</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.ResourceRelationImpl#getSourceCardinality <em>Source Cardinality</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.ResourceRelationImpl#getTargetCardinality <em>Target Cardinality</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.ResourceRelationImpl#isContainment <em>Containment</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.ResourceRelationImpl#isRecursive <em>Recursive</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.ResourceRelationImpl#getSource <em>Source</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.ResourceRelationImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceRelationImpl extends MinimalEObjectImpl.Container implements ResourceRelation {
	...
	protected EClass eStaticClass() {
		return SiriusPackage.Literals.RESOURCE_RELATION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.RESOURCE_RELATION__NAME, oldName,
					name));
	}
	...
	public void setSourceCardinality(String newSourceCardinality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.RESOURCE_RELATION__SOURCE_CARDINALITY,
	...
	public void setTargetCardinality(String newTargetCardinality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.RESOURCE_RELATION__TARGET_CARDINALITY,
	...
	public void setContainment(boolean newContainment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.RESOURCE_RELATION__CONTAINMENT,
	...
	public void setRecursive(boolean newRecursive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.RESOURCE_RELATION__RECURSIVE,
	...
	public ResourceType getSource() {
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.RESOURCE_RELATION__SOURCE,
							oldSource, source));
			}
		}
		return source;
	...
	public void setSource(ResourceType newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.RESOURCE_RELATION__SOURCE, oldSource,
					source));
	}
	...
	public ResourceType getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.RESOURCE_RELATION__TARGET,
							oldTarget, target));
			}
		}
		return target;
	...
	public void setTarget(ResourceType newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.RESOURCE_RELATION__TARGET, oldTarget,
					target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SiriusPackage.RESOURCE_RELATION__NAME:
			return getName();
		case SiriusPackage.RESOURCE_RELATION__SOURCE_CARDINALITY:
			return getSourceCardinality();
		case SiriusPackage.RESOURCE_RELATION__TARGET_CARDINALITY:
			return getTargetCardinality();
		case SiriusPackage.RESOURCE_RELATION__CONTAINMENT:
			return isContainment();
		case SiriusPackage.RESOURCE_RELATION__RECURSIVE:
			return isRecursive();
		case SiriusPackage.RESOURCE_RELATION__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case SiriusPackage.RESOURCE_RELATION__TARGET:
			if (resolve)
				return getTarget();
