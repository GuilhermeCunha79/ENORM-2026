 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.FeedbackDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.FeedbackDefinitionImpl#isRequiresVerifiedContext <em>Requires Verified Context</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.FeedbackDefinitionImpl#isUniquePerAuthorTarget <em>Unique Per Author Target</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.FeedbackDefinitionImpl#getType <em>Type</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.FeedbackDefinitionImpl#getSubjectResource <em>Subject Resource</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.FeedbackDefinitionImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.FeedbackDefinitionImpl#getSubjectFeedback <em>Subject Feedback</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.FeedbackDefinitionImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.FeedbackDefinitionImpl#getPolicy <em>Policy</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.FeedbackDefinitionImpl#getRating <em>Rating</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeedbackDefinitionImpl extends MinimalEObjectImpl.Container implements FeedbackDefinition {
	...
	protected EClass eStaticClass() {
		return SiriusPackage.Literals.FEEDBACK_DEFINITION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.FEEDBACK_DEFINITION__NAME, oldName,
					name));
	}
	...
	public void setRequiresVerifiedContext(boolean newRequiresVerifiedContext) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					SiriusPackage.FEEDBACK_DEFINITION__REQUIRES_VERIFIED_CONTEXT, oldRequiresVerifiedContext,
	...
	public void setUniquePerAuthorTarget(boolean newUniquePerAuthorTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					SiriusPackage.FEEDBACK_DEFINITION__UNIQUE_PER_AUTHOR_TARGET, oldUniquePerAuthorTarget,
	...
	public FeedbackType getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.FEEDBACK_DEFINITION__TYPE,
							oldType, type));
			}
		}
		return type;
	...
	public void setType(FeedbackType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.FEEDBACK_DEFINITION__TYPE, oldType,
					type));
	}
			...
			if (subjectResource != oldSubjectResource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SiriusPackage.FEEDBACK_DEFINITION__SUBJECT_RESOURCE, oldSubjectResource, subjectResource));
			}
		}
	...
	public void setSubjectResource(ResourceType newSubjectResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.FEEDBACK_DEFINITION__SUBJECT_RESOURCE,
	...
	public UserType getAuthor() {
		if (author != null && author.eIsProxy()) {
			...
			if (author != oldAuthor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.FEEDBACK_DEFINITION__AUTHOR,
							oldAuthor, author));
			}
		}
		return author;
	...
	public void setAuthor(UserType newAuthor) {
		...
		author = newAuthor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.FEEDBACK_DEFINITION__AUTHOR, oldAuthor,
					author));
	}
	...
	public FeedbackDefinition getSubjectFeedback() {
		if (subjectFeedback != null && subjectFeedback.eIsProxy()) {
			...
			if (subjectFeedback != oldSubjectFeedback) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SiriusPackage.FEEDBACK_DEFINITION__SUBJECT_FEEDBACK, oldSubjectFeedback, subjectFeedback));
			}
		}
	...
	public void setSubjectFeedback(FeedbackDefinition newSubjectFeedback) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.FEEDBACK_DEFINITION__SUBJECT_FEEDBACK,
	...
	public FeedbackDefinition getParent() {
		if (parent != null && parent.eIsProxy()) {
			...
			if (parent != oldParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.FEEDBACK_DEFINITION__PARENT,
							oldParent, parent));
			}
		}
		return parent;
	...
	public void setParent(FeedbackDefinition newParent) {
		...
		parent = newParent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.FEEDBACK_DEFINITION__PARENT, oldParent,
					parent));
	}
	...
	public NotificationChain basicSetPolicy(FeedbackPolicy newPolicy, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SiriusPackage.FEEDBACK_DEFINITION__POLICY, oldPolicy, newPolicy);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newPolicy != policy) {
			...
			if (policy != null)
				msgs = ((InternalEObject) policy).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - SiriusPackage.FEEDBACK_DEFINITION__POLICY, null, msgs);
			if (newPolicy != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.FEEDBACK_DEFINITION__POLICY, newPolicy,
					newPolicy));
	}
	...
	public NotificationChain basicSetRating(RatingPolicy newRating, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SiriusPackage.FEEDBACK_DEFINITION__RATING, oldRating, newRating);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newRating != rating) {
			...
			if (rating != null)
				msgs = ((InternalEObject) rating).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - SiriusPackage.FEEDBACK_DEFINITION__RATING, null, msgs);
			if (newRating != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.FEEDBACK_DEFINITION__RATING, newRating,
					newRating));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case SiriusPackage.FEEDBACK_DEFINITION__POLICY:
			return basicSetPolicy(null, msgs);
		case SiriusPackage.FEEDBACK_DEFINITION__RATING:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SiriusPackage.FEEDBACK_DEFINITION__NAME:
			return getName();
		case SiriusPackage.FEEDBACK_DEFINITION__REQUIRES_VERIFIED_CONTEXT:
			return isRequiresVerifiedContext();
		case SiriusPackage.FEEDBACK_DEFINITION__UNIQUE_PER_AUTHOR_TARGET:
			return isUniquePerAuthorTarget();
		case SiriusPackage.FEEDBACK_DEFINITION__TYPE:
			if (resolve)
				return getType();
			return basicGetType();
		case SiriusPackage.FEEDBACK_DEFINITION__SUBJECT_RESOURCE:
			if (resolve)
				return getSubjectResource();
			return basicGetSubjectResource();
		case SiriusPackage.FEEDBACK_DEFINITION__AUTHOR:
			if (resolve)
				return getAuthor();
			return basicGetAuthor();
		case SiriusPackage.FEEDBACK_DEFINITION__SUBJECT_FEEDBACK:
			if (resolve)
				return getSubjectFeedback();
			return basicGetSubjectFeedback();
		case SiriusPackage.FEEDBACK_DEFINITION__PARENT:
			if (resolve)
				return getParent();
