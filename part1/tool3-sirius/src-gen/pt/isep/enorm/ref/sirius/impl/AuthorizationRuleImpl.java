 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.AuthorizationRuleImpl#getAllowedAction <em>Allowed Action</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.AuthorizationRuleImpl#getActor <em>Actor</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.AuthorizationRuleImpl#getContext <em>Context</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.AuthorizationRuleImpl#getResourceTarget <em>Resource Target</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.AuthorizationRuleImpl#getFeedbackTarget <em>Feedback Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AuthorizationRuleImpl extends MinimalEObjectImpl.Container implements AuthorizationRule {
	...
	protected EClass eStaticClass() {
		return SiriusPackage.Literals.AUTHORIZATION_RULE;
	}
	...
	public void setAllowedAction(ActionKind newAllowedAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.AUTHORIZATION_RULE__ALLOWED_ACTION,
	...
	public UserType getActor() {
		if (actor != null && actor.eIsProxy()) {
			...
			if (actor != oldActor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.AUTHORIZATION_RULE__ACTOR,
							oldActor, actor));
			}
		}
		return actor;
	...
	public void setActor(UserType newActor) {
		...
		actor = newActor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.AUTHORIZATION_RULE__ACTOR, oldActor,
					actor));
	}
	...
	public ContextType getContext() {
		if (context != null && context.eIsProxy()) {
			...
			if (context != oldContext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.AUTHORIZATION_RULE__CONTEXT,
							oldContext, context));
			}
		}
		return context;
	...
	public void setContext(ContextType newContext) {
		...
		context = newContext;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.AUTHORIZATION_RULE__CONTEXT, oldContext,
					context));
	}
			...
			if (resourceTarget != oldResourceTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SiriusPackage.AUTHORIZATION_RULE__RESOURCE_TARGET, oldResourceTarget, resourceTarget));
			}
		}
	...
	public void setResourceTarget(ResourceType newResourceTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.AUTHORIZATION_RULE__RESOURCE_TARGET,
	...
	public FeedbackDefinition getFeedbackTarget() {
		if (feedbackTarget != null && feedbackTarget.eIsProxy()) {
			...
			if (feedbackTarget != oldFeedbackTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SiriusPackage.AUTHORIZATION_RULE__FEEDBACK_TARGET, oldFeedbackTarget, feedbackTarget));
			}
		}
	...
	public void setFeedbackTarget(FeedbackDefinition newFeedbackTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.AUTHORIZATION_RULE__FEEDBACK_TARGET,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SiriusPackage.AUTHORIZATION_RULE__ALLOWED_ACTION:
			return getAllowedAction();
		case SiriusPackage.AUTHORIZATION_RULE__ACTOR:
			if (resolve)
				return getActor();
			return basicGetActor();
		case SiriusPackage.AUTHORIZATION_RULE__CONTEXT:
			if (resolve)
				return getContext();
			return basicGetContext();
		case SiriusPackage.AUTHORIZATION_RULE__RESOURCE_TARGET:
			if (resolve)
				return getResourceTarget();
			return basicGetResourceTarget();
		case SiriusPackage.AUTHORIZATION_RULE__FEEDBACK_TARGET:
			if (resolve)
