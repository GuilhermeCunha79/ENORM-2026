 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.RatingPolicyImpl#getMinValue <em>Min Value</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.RatingPolicyImpl#getMaxValue <em>Max Value</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.RatingPolicyImpl#getStep <em>Step</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.RatingPolicyImpl#getScaleKind <em>Scale Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RatingPolicyImpl extends MinimalEObjectImpl.Container implements RatingPolicy {
	...
	protected EClass eStaticClass() {
		return SiriusPackage.Literals.RATING_POLICY;
	}
	...
	public void setMinValue(double newMinValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.RATING_POLICY__MIN_VALUE, oldMinValue,
					minValue));
	}
	...
	public void setMaxValue(double newMaxValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.RATING_POLICY__MAX_VALUE, oldMaxValue,
					maxValue));
	}
	...
	public void setStep(double newStep) {
		...
		step = newStep;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.RATING_POLICY__STEP, oldStep, step));
	}
	...
	public void setScaleKind(RatingScaleKind newScaleKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.RATING_POLICY__SCALE_KIND, oldScaleKind,
					scaleKind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SiriusPackage.RATING_POLICY__MIN_VALUE:
			return getMinValue();
		case SiriusPackage.RATING_POLICY__MAX_VALUE:
			return getMaxValue();
		case SiriusPackage.RATING_POLICY__STEP:
			return getStep();
		case SiriusPackage.RATING_POLICY__SCALE_KIND:
			return getScaleKind();
		}
