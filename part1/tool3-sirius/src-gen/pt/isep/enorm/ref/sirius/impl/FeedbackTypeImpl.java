 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.FeedbackTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.FeedbackTypeImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.FeedbackTypeImpl#getSubjectScope <em>Subject Scope</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.FeedbackTypeImpl#isHasRating <em>Has Rating</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.FeedbackTypeImpl#isRecursive <em>Recursive</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.sirius.impl.FeedbackTypeImpl#isAllowsMedia <em>Allows Media</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeedbackTypeImpl extends MinimalEObjectImpl.Container implements FeedbackType {
	...
	protected EClass eStaticClass() {
		return SiriusPackage.Literals.FEEDBACK_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.FEEDBACK_TYPE__NAME, oldName, name));
	}
	...
	public void setKind(FeedbackKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.FEEDBACK_TYPE__KIND, oldKind, kind));
	}
	...
	public void setSubjectScope(FeedbackSubjectScope newSubjectScope) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.FEEDBACK_TYPE__SUBJECT_SCOPE,
	...
	public void setHasRating(boolean newHasRating) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.FEEDBACK_TYPE__HAS_RATING, oldHasRating,
					hasRating));
	}
	...
	public void setRecursive(boolean newRecursive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.FEEDBACK_TYPE__RECURSIVE, oldRecursive,
					recursive));
	}
	...
	public void setAllowsMedia(boolean newAllowsMedia) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.FEEDBACK_TYPE__ALLOWS_MEDIA,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SiriusPackage.FEEDBACK_TYPE__NAME:
			return getName();
		case SiriusPackage.FEEDBACK_TYPE__KIND:
			return getKind();
		case SiriusPackage.FEEDBACK_TYPE__SUBJECT_SCOPE:
			return getSubjectScope();
		case SiriusPackage.FEEDBACK_TYPE__HAS_RATING:
			return isHasRating();
		case SiriusPackage.FEEDBACK_TYPE__RECURSIVE:
			return isRecursive();
		case SiriusPackage.FEEDBACK_TYPE__ALLOWS_MEDIA:
