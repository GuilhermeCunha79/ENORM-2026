 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.ModerationPolicyImpl#getName <em>Name</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.ModerationPolicyImpl#getMode <em>Mode</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.ModerationPolicyImpl#getTrigger <em>Trigger</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.ModerationPolicyImpl#getDecision <em>Decision</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.ModerationPolicyImpl#getMonitorsResource <em>Monitors Resource</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.ModerationPolicyImpl#getMonitorsFeedback <em>Monitors Feedback</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.ModerationPolicyImpl#getExecutedBy <em>Executed By</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.ModerationPolicyImpl#getInContext <em>In Context</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModerationPolicyImpl extends MinimalEObjectImpl.Container implements ModerationPolicy {
	...
	protected EClass eStaticClass() {
		return RefPackage.Literals.MODERATION_POLICY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.MODERATION_POLICY__NAME, oldName, name));
	}
	...
	public void setMode(ModerationMode newMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.MODERATION_POLICY__MODE, oldMode, mode));
	}
	...
	public void setTrigger(TriggerEvent newTrigger) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.MODERATION_POLICY__TRIGGER, oldTrigger,
					trigger));
	}
	...
	public void setDecision(ModerationDecision newDecision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.MODERATION_POLICY__DECISION, oldDecision,
					decision));
	}
			...
			if (monitorsResource != oldMonitorsResource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							RefPackage.MODERATION_POLICY__MONITORS_RESOURCE, oldMonitorsResource, monitorsResource));
			}
		}
	...
	public void setMonitorsResource(ResourceType newMonitorsResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.MODERATION_POLICY__MONITORS_RESOURCE,
	...
	public FeedbackDefinition getMonitorsFeedback() {
		if (monitorsFeedback != null && monitorsFeedback.eIsProxy()) {
			...
			if (monitorsFeedback != oldMonitorsFeedback) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							RefPackage.MODERATION_POLICY__MONITORS_FEEDBACK, oldMonitorsFeedback, monitorsFeedback));
			}
		}
	...
	public void setMonitorsFeedback(FeedbackDefinition newMonitorsFeedback) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.MODERATION_POLICY__MONITORS_FEEDBACK,
	...
	public UserType getExecutedBy() {
		if (executedBy != null && executedBy.eIsProxy()) {
			...
			if (executedBy != oldExecutedBy) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RefPackage.MODERATION_POLICY__EXECUTED_BY,
	...
	public void setExecutedBy(UserType newExecutedBy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.MODERATION_POLICY__EXECUTED_BY,
					oldExecutedBy, executedBy));
	}
	...
	public ContextType getInContext() {
		if (inContext != null && inContext.eIsProxy()) {
			...
			if (inContext != oldInContext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RefPackage.MODERATION_POLICY__IN_CONTEXT,
	...
	public void setInContext(ContextType newInContext) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.MODERATION_POLICY__IN_CONTEXT,
					oldInContext, inContext));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case RefPackage.MODERATION_POLICY__NAME:
			return getName();
		case RefPackage.MODERATION_POLICY__MODE:
			return getMode();
		case RefPackage.MODERATION_POLICY__TRIGGER:
			return getTrigger();
		case RefPackage.MODERATION_POLICY__DECISION:
			return getDecision();
		case RefPackage.MODERATION_POLICY__MONITORS_RESOURCE:
			if (resolve)
				return getMonitorsResource();
			return basicGetMonitorsResource();
		case RefPackage.MODERATION_POLICY__MONITORS_FEEDBACK:
			if (resolve)
				return getMonitorsFeedback();
			return basicGetMonitorsFeedback();
		case RefPackage.MODERATION_POLICY__EXECUTED_BY:
			if (resolve)
				return getExecutedBy();
			return basicGetExecutedBy();
		case RefPackage.MODERATION_POLICY__IN_CONTEXT:
			if (resolve)
				return getInContext();
