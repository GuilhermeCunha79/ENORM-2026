 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.ContextTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.ContextTypeImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.ContextTypeImpl#getContains <em>Contains</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContextTypeImpl extends MinimalEObjectImpl.Container implements ContextType {
	...
	protected EClass eStaticClass() {
		return RefPackage.Literals.CONTEXT_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.CONTEXT_TYPE__NAME, oldName, name));
	}
	...
	public void setKind(ContextKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.CONTEXT_TYPE__KIND, oldKind, kind));
	}
	...
	public EList<ResourceType> getContains() {
		if (contains == null) {
			contains = new EObjectResolvingEList<ResourceType>(ResourceType.class, this,
					RefPackage.CONTEXT_TYPE__CONTAINS);
		}
		return contains;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case RefPackage.CONTEXT_TYPE__KIND:
			return getKind();
		case RefPackage.CONTEXT_TYPE__CONTAINS:
			return getContains();
		}
