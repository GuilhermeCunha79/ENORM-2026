 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.FeedbackTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.FeedbackTypeImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.FeedbackTypeImpl#getSubjectScope <em>Subject Scope</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.FeedbackTypeImpl#isHasRating <em>Has Rating</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.FeedbackTypeImpl#isRecursive <em>Recursive</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.FeedbackTypeImpl#isAllowsText <em>Allows Text</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.FeedbackTypeImpl#isAllowsMedia <em>Allows Media</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.FeedbackTypeImpl#getPolarity <em>Polarity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeedbackTypeImpl extends MinimalEObjectImpl.Container implements FeedbackType {
	...
	protected EClass eStaticClass() {
		return RefPackage.Literals.FEEDBACK_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.FEEDBACK_TYPE__NAME, oldName, name));
	}
	...
	public void setKind(FeedbackKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.FEEDBACK_TYPE__KIND, oldKind, kind));
	}
	...
	public void setSubjectScope(FeedbackSubjectScope newSubjectScope) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.FEEDBACK_TYPE__SUBJECT_SCOPE,
	...
	public void setHasRating(boolean newHasRating) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.FEEDBACK_TYPE__HAS_RATING, oldHasRating,
					hasRating));
	}
	...
	public void setRecursive(boolean newRecursive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.FEEDBACK_TYPE__RECURSIVE, oldRecursive,
					recursive));
	}
	...
	public void setAllowsText(boolean newAllowsText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.FEEDBACK_TYPE__ALLOWS_TEXT, oldAllowsText,
					allowsText));
	}
	...
	public void setAllowsMedia(boolean newAllowsMedia) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.FEEDBACK_TYPE__ALLOWS_MEDIA,
	...
	public void setPolarity(FeedbackPolarity newPolarity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.FEEDBACK_TYPE__POLARITY, oldPolarity,
					polarity));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case RefPackage.FEEDBACK_TYPE__NAME:
			return getName();
		case RefPackage.FEEDBACK_TYPE__KIND:
			return getKind();
		case RefPackage.FEEDBACK_TYPE__SUBJECT_SCOPE:
			return getSubjectScope();
		case RefPackage.FEEDBACK_TYPE__HAS_RATING:
			return isHasRating();
		case RefPackage.FEEDBACK_TYPE__RECURSIVE:
			return isRecursive();
		case RefPackage.FEEDBACK_TYPE__ALLOWS_TEXT:
			return isAllowsText();
		case RefPackage.FEEDBACK_TYPE__ALLOWS_MEDIA:
			return isAllowsMedia();
		case RefPackage.FEEDBACK_TYPE__POLARITY:
			return getPolarity();
		}
