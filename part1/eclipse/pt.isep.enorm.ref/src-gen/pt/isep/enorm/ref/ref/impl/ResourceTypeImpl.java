 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.ResourceTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.ResourceTypeImpl#isSupportsMedia <em>Supports Media</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.ResourceTypeImpl#getSuperTypes <em>Super Types</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.ResourceTypeImpl#getAttributes <em>Attributes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceTypeImpl extends MinimalEObjectImpl.Container implements ResourceType {
	...
	protected EClass eStaticClass() {
		return RefPackage.Literals.RESOURCE_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.RESOURCE_TYPE__NAME, oldName, name));
	}
	...
	public void setSupportsMedia(boolean newSupportsMedia) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.RESOURCE_TYPE__SUPPORTS_MEDIA,
	...
	public EList<ResourceType> getSuperTypes() {
		if (superTypes == null) {
			superTypes = new EObjectResolvingEList<ResourceType>(ResourceType.class, this,
					RefPackage.RESOURCE_TYPE__SUPER_TYPES);
		}
		return superTypes;
	}
	...
	public EList<Attribute> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<Attribute>(Attribute.class, this,
					RefPackage.RESOURCE_TYPE__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RefPackage.RESOURCE_TYPE__ATTRIBUTES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case RefPackage.RESOURCE_TYPE__NAME:
			return getName();
		case RefPackage.RESOURCE_TYPE__SUPPORTS_MEDIA:
			return isSupportsMedia();
		case RefPackage.RESOURCE_TYPE__SUPER_TYPES:
