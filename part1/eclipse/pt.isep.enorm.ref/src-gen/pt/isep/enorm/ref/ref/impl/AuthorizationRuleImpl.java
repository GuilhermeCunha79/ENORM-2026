 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.AuthorizationRuleImpl#getName <em>Name</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.AuthorizationRuleImpl#getAllowedAction <em>Allowed Action</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.AuthorizationRuleImpl#getActor <em>Actor</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.AuthorizationRuleImpl#getContext <em>Context</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.AuthorizationRuleImpl#getResourceTarget <em>Resource Target</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.AuthorizationRuleImpl#getFeedbackTarget <em>Feedback Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AuthorizationRuleImpl extends MinimalEObjectImpl.Container implements AuthorizationRule {
	...
	protected EClass eStaticClass() {
		return RefPackage.Literals.AUTHORIZATION_RULE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.AUTHORIZATION_RULE__NAME, oldName, name));
	}
	...
	public void setAllowedAction(ActionKind newAllowedAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.AUTHORIZATION_RULE__ALLOWED_ACTION,
	...
	public UserType getActor() {
		if (actor != null && actor.eIsProxy()) {
			...
			if (actor != oldActor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RefPackage.AUTHORIZATION_RULE__ACTOR,
							oldActor, actor));
			}
		}
		return actor;
	...
	public void setActor(UserType newActor) {
		...
		actor = newActor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.AUTHORIZATION_RULE__ACTOR, oldActor,
					actor));
	}
	...
	public ContextType getContext() {
		if (context != null && context.eIsProxy()) {
			...
			if (context != oldContext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RefPackage.AUTHORIZATION_RULE__CONTEXT,
							oldContext, context));
			}
		}
		return context;
	...
	public void setContext(ContextType newContext) {
		...
		context = newContext;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.AUTHORIZATION_RULE__CONTEXT, oldContext,
					context));
	}
			...
			if (resourceTarget != oldResourceTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							RefPackage.AUTHORIZATION_RULE__RESOURCE_TARGET, oldResourceTarget, resourceTarget));
			}
		}
	...
	public void setResourceTarget(ResourceType newResourceTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.AUTHORIZATION_RULE__RESOURCE_TARGET,
	...
	public FeedbackDefinition getFeedbackTarget() {
		if (feedbackTarget != null && feedbackTarget.eIsProxy()) {
			...
			if (feedbackTarget != oldFeedbackTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							RefPackage.AUTHORIZATION_RULE__FEEDBACK_TARGET, oldFeedbackTarget, feedbackTarget));
			}
		}
	...
	public void setFeedbackTarget(FeedbackDefinition newFeedbackTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.AUTHORIZATION_RULE__FEEDBACK_TARGET,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case RefPackage.AUTHORIZATION_RULE__ACTOR:
			if (resolve)
				return getActor();
			return basicGetActor();
		case RefPackage.AUTHORIZATION_RULE__CONTEXT:
			if (resolve)
				return getContext();
			return basicGetContext();
		case RefPackage.AUTHORIZATION_RULE__RESOURCE_TARGET:
			if (resolve)
				return getResourceTarget();
			return basicGetResourceTarget();
		case RefPackage.AUTHORIZATION_RULE__FEEDBACK_TARGET:
			if (resolve)
