 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.FeedbackDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.FeedbackDefinitionImpl#isRequiresVerifiedContext <em>Requires Verified Context</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.FeedbackDefinitionImpl#getVerificationRequirement <em>Verification Requirement</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.FeedbackDefinitionImpl#isUniquePerAuthorTarget <em>Unique Per Author Target</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.FeedbackDefinitionImpl#getType <em>Type</em>}</li>
...
public class FeedbackDefinitionImpl extends MinimalEObjectImpl.Container implements FeedbackDefinition {
	...
	protected EClass eStaticClass() {
		return RefPackage.Literals.FEEDBACK_DEFINITION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.FEEDBACK_DEFINITION__NAME, oldName, name));
	}
	...
	public void setRequiresVerifiedContext(boolean newRequiresVerifiedContext) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RefPackage.FEEDBACK_DEFINITION__REQUIRES_VERIFIED_CONTEXT, oldRequiresVerifiedContext,
	...
	public void setVerificationRequirement(VerificationRequirement newVerificationRequirement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RefPackage.FEEDBACK_DEFINITION__VERIFICATION_REQUIREMENT, oldVerificationRequirement,
	...
	public void setUniquePerAuthorTarget(boolean newUniquePerAuthorTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RefPackage.FEEDBACK_DEFINITION__UNIQUE_PER_AUTHOR_TARGET, oldUniquePerAuthorTarget,
	...
	public FeedbackType getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RefPackage.FEEDBACK_DEFINITION__TYPE,
							oldType, type));
			}
		}
		return type;
	...
	public void setType(FeedbackType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.FEEDBACK_DEFINITION__TYPE, oldType, type));
	}
			...
			if (subjectResource != oldSubjectResource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							RefPackage.FEEDBACK_DEFINITION__SUBJECT_RESOURCE, oldSubjectResource, subjectResource));
			}
		}
	...
	public void setSubjectResource(ResourceType newSubjectResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.FEEDBACK_DEFINITION__SUBJECT_RESOURCE,
	...
	public UserType getAuthor() {
		if (author != null && author.eIsProxy()) {
			...
			if (author != oldAuthor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RefPackage.FEEDBACK_DEFINITION__AUTHOR,
							oldAuthor, author));
			}
		}
		return author;
	...
	public void setAuthor(UserType newAuthor) {
		...
		author = newAuthor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.FEEDBACK_DEFINITION__AUTHOR, oldAuthor,
					author));
	}
	...
	public FeedbackDefinition getSubjectFeedback() {
		if (subjectFeedback != null && subjectFeedback.eIsProxy()) {
			...
			if (subjectFeedback != oldSubjectFeedback) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							RefPackage.FEEDBACK_DEFINITION__SUBJECT_FEEDBACK, oldSubjectFeedback, subjectFeedback));
			}
		}
	...
	public void setSubjectFeedback(FeedbackDefinition newSubjectFeedback) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.FEEDBACK_DEFINITION__SUBJECT_FEEDBACK,
	...
	public NotificationChain basicSetPolicy(FeedbackPolicy newPolicy, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RefPackage.FEEDBACK_DEFINITION__POLICY, oldPolicy, newPolicy);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newPolicy != policy) {
			...
			if (policy != null)
				msgs = ((InternalEObject) policy).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RefPackage.FEEDBACK_DEFINITION__POLICY, null, msgs);
			if (newPolicy != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.FEEDBACK_DEFINITION__POLICY, newPolicy,
					newPolicy));
	}
	...
	public NotificationChain basicSetRating(RatingPolicy newRating, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RefPackage.FEEDBACK_DEFINITION__RATING, oldRating, newRating);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newRating != rating) {
			...
			if (rating != null)
				msgs = ((InternalEObject) rating).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RefPackage.FEEDBACK_DEFINITION__RATING, null, msgs);
			if (newRating != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.FEEDBACK_DEFINITION__RATING, newRating,
					newRating));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case RefPackage.FEEDBACK_DEFINITION__TYPE:
			if (resolve)
				return getType();
			return basicGetType();
		case RefPackage.FEEDBACK_DEFINITION__SUBJECT_RESOURCE:
			if (resolve)
				return getSubjectResource();
			return basicGetSubjectResource();
		case RefPackage.FEEDBACK_DEFINITION__AUTHOR:
			if (resolve)
				return getAuthor();
