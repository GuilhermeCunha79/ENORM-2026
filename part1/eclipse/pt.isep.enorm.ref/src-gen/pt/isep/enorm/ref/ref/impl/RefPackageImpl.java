...
public class RefPackageImpl extends EPackageImpl implements RefPackage {
	 ...
	 * @see pt.isep.enorm.ref.ref.RefPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static RefPackage init() {
		if (isInited)
			return (RefPackage) EPackage.Registry.INSTANCE.getEPackage(RefPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredRefPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		RefPackageImpl theRefPackage = registeredRefPackage instanceof RefPackageImpl
				? (RefPackageImpl) registeredRefPackage
				: new RefPackageImpl();
	...
	public void initializePackageContents() {
		...
		initEReference(getResourceType_SuperTypes(), this.getResourceType(), null, "superTypes", null, 0, -1,
				...
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getResourceType_Attributes(), this.getAttribute(), null, "attributes", null, 0, -1,
				ResourceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
