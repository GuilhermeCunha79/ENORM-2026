 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.VerificationPolicyImpl#getName <em>Name</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.VerificationPolicyImpl#getMode <em>Mode</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.VerificationPolicyImpl#getAppliesWhen <em>Applies When</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.VerificationPolicyImpl#getVerifies <em>Verifies</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VerificationPolicyImpl extends MinimalEObjectImpl.Container implements VerificationPolicy {
	...
	protected EClass eStaticClass() {
		return RefPackage.Literals.VERIFICATION_POLICY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.VERIFICATION_POLICY__NAME, oldName, name));
	}
	...
	public void setMode(ValidationKind newMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.VERIFICATION_POLICY__MODE, oldMode, mode));
	}
	...
	public void setAppliesWhen(TriggerEvent newAppliesWhen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.VERIFICATION_POLICY__APPLIES_WHEN,
	...
	public FeedbackDefinition getVerifies() {
		if (verifies != null && verifies.eIsProxy()) {
			...
			if (verifies != oldVerifies) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RefPackage.VERIFICATION_POLICY__VERIFIES,
	...
	public void setVerifies(FeedbackDefinition newVerifies) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.VERIFICATION_POLICY__VERIFIES, oldVerifies,
					verifies));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case RefPackage.VERIFICATION_POLICY__VERIFIES:
			if (resolve)
				return getVerifies();
