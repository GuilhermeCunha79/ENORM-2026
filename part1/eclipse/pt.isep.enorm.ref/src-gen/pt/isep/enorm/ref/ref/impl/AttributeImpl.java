 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.AttributeImpl#getName <em>Name</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.AttributeImpl#getType <em>Type</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.AttributeImpl#isRequired <em>Required</em>}</li>
 *   <li>{@link pt.isep.enorm.ref.ref.impl.AttributeImpl#isMultiValued <em>Multi Valued</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributeImpl extends MinimalEObjectImpl.Container implements Attribute {
	...
	protected EClass eStaticClass() {
		return RefPackage.Literals.ATTRIBUTE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.ATTRIBUTE__NAME, oldName, name));
	}
	...
	public void setType(PrimitiveType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.ATTRIBUTE__TYPE, oldType, type));
	}
	...
	public void setRequired(boolean newRequired) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.ATTRIBUTE__REQUIRED, oldRequired,
					required));
	}
	...
	public void setMultiValued(boolean newMultiValued) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefPackage.ATTRIBUTE__MULTI_VALUED, oldMultiValued,
					multiValued));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case RefPackage.ATTRIBUTE__NAME:
			return getName();
		case RefPackage.ATTRIBUTE__TYPE:
			return getType();
		case RefPackage.ATTRIBUTE__REQUIRED:
			return isRequired();
		case RefPackage.ATTRIBUTE__MULTI_VALUED:
