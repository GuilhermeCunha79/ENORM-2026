...
/**
 * This is the item provider adapter for a {@link pt.isep.enorm.ref.ref.FeedbackType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						RefPackage.Literals.FEEDBACK_TYPE__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_FeedbackType_kind_feature",
								"_UI_FeedbackType_type"),
						RefPackage.Literals.FEEDBACK_TYPE__KIND, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_FeedbackType_subjectScope_feature",
								"_UI_FeedbackType_type"),
						RefPackage.Literals.FEEDBACK_TYPE__SUBJECT_SCOPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_FeedbackType_hasRating_feature",
								"_UI_FeedbackType_type"),
						RefPackage.Literals.FEEDBACK_TYPE__HAS_RATING, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_FeedbackType_recursive_feature",
								"_UI_FeedbackType_type"),
						RefPackage.Literals.FEEDBACK_TYPE__RECURSIVE, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_FeedbackType_allowsText_feature",
								"_UI_FeedbackType_type"),
						RefPackage.Literals.FEEDBACK_TYPE__ALLOWS_TEXT, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_FeedbackType_allowsMedia_feature",
								"_UI_FeedbackType_type"),
						RefPackage.Literals.FEEDBACK_TYPE__ALLOWS_MEDIA, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_FeedbackType_polarity_feature",
								"_UI_FeedbackType_type"),
						RefPackage.Literals.FEEDBACK_TYPE__POLARITY, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
