...
/**
 * This is the item provider adapter for a {@link pt.isep.enorm.ref.ref.AutomationRule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AutomationRuleItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						RefPackage.Literals.AUTOMATION_RULE__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_AutomationRule_trigger_feature",
								"_UI_AutomationRule_type"),
						RefPackage.Literals.AUTOMATION_RULE__TRIGGER, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_AutomationRule_context_feature",
								"_UI_AutomationRule_type"),
						RefPackage.Literals.AUTOMATION_RULE__CONTEXT, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_AutomationRule_inContext_feature",
								"_UI_AutomationRule_type"),
						RefPackage.Literals.AUTOMATION_RULE__IN_CONTEXT, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_AutomationRule_onFeedback_feature",
								"_UI_AutomationRule_type"),
						RefPackage.Literals.AUTOMATION_RULE__ON_FEEDBACK, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RefPackage.Literals.AUTOMATION_RULE__CONDITIONS);
			childrenFeatures.add(RefPackage.Literals.AUTOMATION_RULE__ACTIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(RefPackage.Literals.AUTOMATION_RULE__CONDITIONS,
				RefFactory.eINSTANCE.createCondition()));

		newChildDescriptors.add(createChildParameter(RefPackage.Literals.AUTOMATION_RULE__ACTIONS,
				RefFactory.eINSTANCE.createAction()));
	}
