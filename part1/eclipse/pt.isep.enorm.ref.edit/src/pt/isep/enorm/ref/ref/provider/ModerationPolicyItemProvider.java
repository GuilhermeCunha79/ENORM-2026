...
/**
 * This is the item provider adapter for a {@link pt.isep.enorm.ref.ref.ModerationPolicy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModerationPolicyItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						RefPackage.Literals.MODERATION_POLICY__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ModerationPolicy_mode_feature",
								"_UI_ModerationPolicy_type"),
						RefPackage.Literals.MODERATION_POLICY__MODE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ModerationPolicy_trigger_feature",
								"_UI_ModerationPolicy_type"),
						RefPackage.Literals.MODERATION_POLICY__TRIGGER, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ModerationPolicy_decision_feature",
								"_UI_ModerationPolicy_type"),
						RefPackage.Literals.MODERATION_POLICY__DECISION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addMonitorsResourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ModerationPolicy_monitorsResource_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ModerationPolicy_monitorsResource_feature",
								"_UI_ModerationPolicy_type"),
						RefPackage.Literals.MODERATION_POLICY__MONITORS_RESOURCE, true, false, true, null, null, null));
	}
	...
	protected void addMonitorsFeedbackPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ModerationPolicy_monitorsFeedback_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ModerationPolicy_monitorsFeedback_feature",
								"_UI_ModerationPolicy_type"),
						RefPackage.Literals.MODERATION_POLICY__MONITORS_FEEDBACK, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ModerationPolicy_executedBy_feature",
								"_UI_ModerationPolicy_type"),
						RefPackage.Literals.MODERATION_POLICY__EXECUTED_BY, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ModerationPolicy_inContext_feature",
								"_UI_ModerationPolicy_type"),
						RefPackage.Literals.MODERATION_POLICY__IN_CONTEXT, true, false, true, null, null, null));
	}
