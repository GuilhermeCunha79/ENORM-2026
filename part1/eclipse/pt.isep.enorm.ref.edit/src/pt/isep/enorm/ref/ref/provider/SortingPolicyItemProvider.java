...
/**
 * This is the item provider adapter for a {@link pt.isep.enorm.ref.ref.SortingPolicy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						RefPackage.Literals.SORTING_POLICY__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_SortingPolicy_criterion_feature",
								"_UI_SortingPolicy_type"),
						RefPackage.Literals.SORTING_POLICY__CRITERION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_SortingPolicy_direction_feature",
								"_UI_SortingPolicy_type"),
						RefPackage.Literals.SORTING_POLICY__DIRECTION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_SortingPolicy_appliesToResource_feature",
								"_UI_SortingPolicy_type"),
						RefPackage.Literals.SORTING_POLICY__APPLIES_TO_RESOURCE, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_SortingPolicy_appliesToFeedback_feature",
								"_UI_SortingPolicy_type"),
						RefPackage.Literals.SORTING_POLICY__APPLIES_TO_FEEDBACK, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_SortingPolicy_inContext_feature",
								"_UI_SortingPolicy_type"),
						RefPackage.Literals.SORTING_POLICY__IN_CONTEXT, true, false, true, null, null, null));
	}
