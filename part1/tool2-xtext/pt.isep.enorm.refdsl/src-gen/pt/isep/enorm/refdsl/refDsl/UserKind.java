 ...
 * <!-- end-user-doc -->
 * @see pt.isep.enorm.refdsl.refDsl.RefDslPackage#getUserKind()
 * @model
 * @generated
 */
public enum UserKind implements Enumerator
{
   ...
   * @generated
   */
  private static final UserKind[] VALUES_ARRAY =
    new UserKind[]
    {
      GENERIC,
      BUYER,
  ...
  public static UserKind get(int value)
  {
    switch (value)
    {
      ...
      case BUYER_VALUE: return BUYER;
      case SELLER_VALUE: return SELLER;
      case CREATOR_VALUE: return CREATOR;
      case MODERATOR_VALUE: return MODERATOR;
    }
    return null;
  }
