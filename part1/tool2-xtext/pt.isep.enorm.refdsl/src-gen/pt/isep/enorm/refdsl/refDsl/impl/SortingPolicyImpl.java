 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.enorm.refdsl.refDsl.impl.SortingPolicyImpl#getName <em>Name</em>}</li>
 *   <li>{@link pt.isep.enorm.refdsl.refDsl.impl.SortingPolicyImpl#getCriterion <em>Criterion</em>}</li>
 *   <li>{@link pt.isep.enorm.refdsl.refDsl.impl.SortingPolicyImpl#getDirection <em>Direction</em>}</li>
 *   <li>{@link pt.isep.enorm.refdsl.refDsl.impl.SortingPolicyImpl#getAppliesToResource <em>Applies To Resource</em>}</li>
 *   <li>{@link pt.isep.enorm.refdsl.refDsl.impl.SortingPolicyImpl#getAppliesToFeedback <em>Applies To Feedback</em>}</li>
 *   <li>{@link pt.isep.enorm.refdsl.refDsl.impl.SortingPolicyImpl#getInContext <em>In Context</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SortingPolicyImpl extends MinimalEObjectImpl.Container implements SortingPolicy
{
  ...
  {
    return RefDslPackage.Literals.SORTING_POLICY;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RefDslPackage.SORTING_POLICY__NAME, oldName, name));
  }
  ...
  public void setCriterion(SortCriterion newCriterion)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RefDslPackage.SORTING_POLICY__CRITERION, oldCriterion, criterion));
  }
  ...
  public void setDirection(SortDirection newDirection)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RefDslPackage.SORTING_POLICY__DIRECTION, oldDirection, direction));
  }
  ...
  public ResourceType getAppliesToResource()
  {
    if (appliesToResource != null && appliesToResource.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RefDslPackage.SORTING_POLICY__APPLIES_TO_RESOURCE, oldAppliesToResource, appliesToResource));
      }
    }
  ...
  public void setAppliesToResource(ResourceType newAppliesToResource)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RefDslPackage.SORTING_POLICY__APPLIES_TO_RESOURCE, oldAppliesToResource, appliesToResource));
  }
  ...
  public FeedbackDefinition getAppliesToFeedback()
  {
    if (appliesToFeedback != null && appliesToFeedback.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RefDslPackage.SORTING_POLICY__APPLIES_TO_FEEDBACK, oldAppliesToFeedback, appliesToFeedback));
      }
    }
  ...
  public void setAppliesToFeedback(FeedbackDefinition newAppliesToFeedback)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RefDslPackage.SORTING_POLICY__APPLIES_TO_FEEDBACK, oldAppliesToFeedback, appliesToFeedback));
  }
  ...
  public ContextType getInContext()
  {
    if (inContext != null && inContext.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RefDslPackage.SORTING_POLICY__IN_CONTEXT, oldInContext, inContext));
      }
    }
    return inContext;
  }
  ...
  public void setInContext(ContextType newInContext)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RefDslPackage.SORTING_POLICY__IN_CONTEXT, oldInContext, inContext));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RefDslPackage.SORTING_POLICY__NAME:
        return getName();
      case RefDslPackage.SORTING_POLICY__CRITERION:
        return getCriterion();
      case RefDslPackage.SORTING_POLICY__DIRECTION:
        return getDirection();
      case RefDslPackage.SORTING_POLICY__APPLIES_TO_RESOURCE:
        if (resolve) return getAppliesToResource();
        return basicGetAppliesToResource();
      case RefDslPackage.SORTING_POLICY__APPLIES_TO_FEEDBACK:
        if (resolve) return getAppliesToFeedback();
        return basicGetAppliesToFeedback();
      case RefDslPackage.SORTING_POLICY__IN_CONTEXT:
