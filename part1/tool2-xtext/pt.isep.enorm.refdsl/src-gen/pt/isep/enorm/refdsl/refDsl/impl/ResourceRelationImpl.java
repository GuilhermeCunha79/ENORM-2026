 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.enorm.refdsl.refDsl.impl.ResourceRelationImpl#getName <em>Name</em>}</li>
 *   <li>{@link pt.isep.enorm.refdsl.refDsl.impl.ResourceRelationImpl#getSource <em>Source</em>}</li>
 *   <li>{@link pt.isep.enorm.refdsl.refDsl.impl.ResourceRelationImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link pt.isep.enorm.refdsl.refDsl.impl.ResourceRelationImpl#getSourceCardinality <em>Source Cardinality</em>}</li>
 *   <li>{@link pt.isep.enorm.refdsl.refDsl.impl.ResourceRelationImpl#getTargetCardinality <em>Target Cardinality</em>}</li>
 *   <li>{@link pt.isep.enorm.refdsl.refDsl.impl.ResourceRelationImpl#isContainment <em>Containment</em>}</li>
 *   <li>{@link pt.isep.enorm.refdsl.refDsl.impl.ResourceRelationImpl#isRecursive <em>Recursive</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceRelationImpl extends MinimalEObjectImpl.Container implements ResourceRelation
{
  ...
  {
    return RefDslPackage.Literals.RESOURCE_RELATION;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RefDslPackage.RESOURCE_RELATION__NAME, oldName, name));
  }
  ...
  public ResourceType getSource()
  {
    if (source != null && source.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RefDslPackage.RESOURCE_RELATION__SOURCE, oldSource, source));
      }
    }
    return source;
  }
  ...
  public void setSource(ResourceType newSource)
  {
    ...
    source = newSource;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RefDslPackage.RESOURCE_RELATION__SOURCE, oldSource, source));
  }
  ...
  public ResourceType getTarget()
  {
    if (target != null && target.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RefDslPackage.RESOURCE_RELATION__TARGET, oldTarget, target));
      }
    }
    return target;
  }
  ...
  public void setTarget(ResourceType newTarget)
  {
    ...
    target = newTarget;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RefDslPackage.RESOURCE_RELATION__TARGET, oldTarget, target));
  }
  ...
  public void setSourceCardinality(String newSourceCardinality)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RefDslPackage.RESOURCE_RELATION__SOURCE_CARDINALITY, oldSourceCardinality, sourceCardinality));
  }
  ...
  public void setTargetCardinality(String newTargetCardinality)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RefDslPackage.RESOURCE_RELATION__TARGET_CARDINALITY, oldTargetCardinality, targetCardinality));
  }
  ...
  public void setContainment(boolean newContainment)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RefDslPackage.RESOURCE_RELATION__CONTAINMENT, oldContainment, containment));
  }
  ...
  public void setRecursive(boolean newRecursive)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RefDslPackage.RESOURCE_RELATION__RECURSIVE, oldRecursive, recursive));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RefDslPackage.RESOURCE_RELATION__NAME:
        return getName();
      case RefDslPackage.RESOURCE_RELATION__SOURCE:
        if (resolve) return getSource();
        return basicGetSource();
      case RefDslPackage.RESOURCE_RELATION__TARGET:
        if (resolve) return getTarget();
        return basicGetTarget();
      case RefDslPackage.RESOURCE_RELATION__SOURCE_CARDINALITY:
        return getSourceCardinality();
      case RefDslPackage.RESOURCE_RELATION__TARGET_CARDINALITY:
        return getTargetCardinality();
      case RefDslPackage.RESOURCE_RELATION__CONTAINMENT:
        return isContainment();
      case RefDslPackage.RESOURCE_RELATION__RECURSIVE:
        return isRecursive();
    }
  ...
  public boolean eIsSet(int featureID)
  {
    switch (featureID)
    {
      ...
      case RefDslPackage.RESOURCE_RELATION__TARGET:
        return target != null;
      case RefDslPackage.RESOURCE_RELATION__SOURCE_CARDINALITY:
        return SOURCE_CARDINALITY_EDEFAULT == null ? sourceCardinality != null : !SOURCE_CARDINALITY_EDEFAULT.equals(sourceCardinality);
      case RefDslPackage.RESOURCE_RELATION__TARGET_CARDINALITY:
        return TARGET_CARDINALITY_EDEFAULT == null ? targetCardinality != null : !TARGET_CARDINALITY_EDEFAULT.equals(targetCardinality);
      case RefDslPackage.RESOURCE_RELATION__CONTAINMENT:
