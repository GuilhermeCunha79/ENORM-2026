...
public class AttributeImpl extends MinimalEObjectImpl.Container implements Attribute
{
  ...
  {
    return RefDslPackage.Literals.ATTRIBUTE;
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RefDslPackage.ATTRIBUTE__NAME, oldName, name));
  }
  ...
  public void setType(PrimitiveType newType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RefDslPackage.ATTRIBUTE__TYPE, oldType, type));
  }
