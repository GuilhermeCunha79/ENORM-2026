 ...
 * <!-- end-user-doc -->
 * @see pt.isep.enorm.refdsl.refDsl.RefDslPackage#getModerationDecision()
 * @model
 * @generated
 */
public enum ModerationDecision implements Enumerator
{
   ...
   * @generated
   */
  private static final ModerationDecision[] VALUES_ARRAY =
  ...
  public static ModerationDecision get(int value)
  {
    switch (value)
    {
      ...
      case FLAGGED_VALUE: return FLAGGED;
