 ...
 * <!-- end-user-doc -->
 * @see pt.isep.enorm.refdsl.refDsl.RefDslPackage#getFeedbackSubjectScope()
 * @model
 * @generated
 */
public enum FeedbackSubjectScope implements Enumerator
{
   ...
   * @generated
   */
  private static final FeedbackSubjectScope[] VALUES_ARRAY =
    new FeedbackSubjectScope[]
    {
      RESOURCE_ONLY,
      FEEDBACK_ONLY,
  ...
  public static FeedbackSubjectScope get(int value)
  {
    switch (value)
    {
      case RESOURCE_ONLY_VALUE: return RESOURCE_ONLY;
      case FEEDBACK_ONLY_VALUE: return FEEDBACK_ONLY;
      case RESOURCE_OR_FEEDBACK_VALUE: return RESOURCE_OR_FEEDBACK;
    }
    return null;
  }
