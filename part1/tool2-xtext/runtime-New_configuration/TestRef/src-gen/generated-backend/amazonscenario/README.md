# Generated REF Backend — AmazonScenario
...
```powershell
mvn -f generated-backend/amazonscenario/pom.xml spring-boot:run
```
...
Open the `.refdsl` file in the RefDsl Editor (runtime Eclipse) and save — output appears under `generated-backend/amazonscenario/`.
