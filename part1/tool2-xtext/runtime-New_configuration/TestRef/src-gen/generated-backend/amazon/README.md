...
```powershell
mvn -f generated-backend/amazon/pom.xml spring-boot:run
```
...
Open the `.refdsl` file in the RefDsl Editor (runtime Eclipse) and save — output appears under `generated-backend/amazon/`.
