...
/**
 * This is the item provider adapter for a {@link enorm.FeedbackDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeedbackDefinitionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						EnormPackage.Literals.FEEDBACK_DEFINITION__NAME, true, false, false,
	...
	protected void addUniquePerAuthorTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						EnormPackage.Literals.FEEDBACK_DEFINITION__UNIQUE_PER_AUTHOR_TARGET, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_FeedbackDefinition_type_feature",
								"_UI_FeedbackDefinition_type"),
						EnormPackage.Literals.FEEDBACK_DEFINITION__TYPE, true, false, true, null, null, null));
	}
	...
	protected void addSubjectResourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_FeedbackDefinition_subjectResource_feature",
						"_UI_FeedbackDefinition_type"),
				EnormPackage.Literals.FEEDBACK_DEFINITION__SUBJECT_RESOURCE, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_FeedbackDefinition_author_feature",
								"_UI_FeedbackDefinition_type"),
						EnormPackage.Literals.FEEDBACK_DEFINITION__AUTHOR, true, false, true, null, null, null));
	}
	...
	protected void addSubjectFeedbackPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_FeedbackDefinition_subjectFeedback_feature",
						"_UI_FeedbackDefinition_type"),
				EnormPackage.Literals.FEEDBACK_DEFINITION__SUBJECT_FEEDBACK, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EnormPackage.Literals.FEEDBACK_DEFINITION__POLICY);
			childrenFeatures.add(EnormPackage.Literals.FEEDBACK_DEFINITION__RATING);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(EnormPackage.Literals.FEEDBACK_DEFINITION__POLICY,
				EnormFactory.eINSTANCE.createFeedbackPolicy()));

		newChildDescriptors.add(createChildParameter(EnormPackage.Literals.FEEDBACK_DEFINITION__RATING,
				EnormFactory.eINSTANCE.createRatingPolicy()));
	}
