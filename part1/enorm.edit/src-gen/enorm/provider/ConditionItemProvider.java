...
public class ConditionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Condition_field_feature",
								"_UI_Condition_type"),
						EnormPackage.Literals.CONDITION__FIELD, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Condition_value_feature",
								"_UI_Condition_type"),
						EnormPackage.Literals.CONDITION__VALUE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case EnormPackage.CONDITION__FIELD:
		case EnormPackage.CONDITION__OPERATOR:
		case EnormPackage.CONDITION__VALUE:
